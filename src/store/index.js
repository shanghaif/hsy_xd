...
import homebrand from './modules/homebrand'// 品牌信息


import keep from './modules/keep'// 移动监管
...
export default new Vuex.Store({
  ...
  plugins: [
    createPersistedState({
      key: 'dsmall',
      paths: ['member', 'seller', 'config', 'home', 'homecart', 'goodsdetail', 'pointsgoods','homebrand','keep']
    })
  ]
})
