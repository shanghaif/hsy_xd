...
const mutations = {
  ...
  savecertificate_info (state, value) {
    state.certificate_info = value
  },
  saveMenuList (state, value) {
	  state.menuList = value
  },
	saveUpGrape (state, value) {
	  state.upgrape = value
  },
}
// actions
const actions = {
  ...
  getGoodsDetail ({ commit, state }, params) {
    return new Promise((resolve, reject) => {
      ...
      getGoodsInfo(params.terminal_id, params.form_id, params.goods_id, params.token, params.extra).then(res => {
        ...
        commit('savecertificate_info', res.result.certificate_info)
		commit('saveMenuList', res.result.menu_list)
        resolve(res)
      }, (error) => {
        reject(error)
      })
