...
<div>
  ...
  <div class="q_see">
      ...
      <!-- 上面输入框 -->
      <div v-show="!imgState" class="img_cont container" ref="imageDom">        
        ...
        <!-- <p style="margin-top: 72px;text-align: center;">{{resObj.store_name}}</p> -->
...
export default {
  ...
  methods: {
    fun_loading(){
      this.resObj = this.certificate_info;
      this.qr = new QRCode(document.getElementById("qrcode"), {
        width: 60,
        height: 60, // 高度
        text: env.H5_HOST + "/home/qsee3?id="+this.resObj.certificate_id+"&n=1" // 二维码内容
      })
      // 拼接
      var that = this;
      this.$nextTick(()=>{
