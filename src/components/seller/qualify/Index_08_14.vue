    ...
    <div class="content">
      ...
      <mt-tab-container v-model="selected">
        ...
        <mt-tab-container-item id="2">
          <div class="mt2">
            <div 
            v-if="info.storeclass_id == 32||info.storeclass_id == 41||info.storeclass_id == 42"
...
import { getQualify, getMyQualify } from "../../../api/sellerQualify";//获取 证书列表
export default {
  data(){
    return {
      selected: '1',
