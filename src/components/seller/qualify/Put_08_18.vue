...
<div>
  ...
  <div class="q_put">
      ...
      <div v-if="id>0" class="top_cont">
        ...
        <div class="name">
          <mt-field label="商户名称：" v-model="store_name" @blur.native.capture="showSearch = false" @focus.native.capture="fun_first"></mt-field>

          <!--  -->
          <a v-if="showSearch" class="mint-cell mint-field searchlist">
...
export default {
  data () {
    return {
      ...
      store_id:null,  //商家编号
      num:null,    //数量
      certificate_no:null,source_id:null,
      storeList:[],    //商家列表
      ...
      firstClick:true,   ///首次点击输入框
      twoClick:true,     ////首次点击输入框后 查询出数据 显示
    }
  },
  components:{
