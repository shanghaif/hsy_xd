...
<div>
  ...
  <div class="step2" v-show="cropDataShow">
    ...
    <div>
      ...
      <mt-field label="注册资金（万元）" type="number" v-model="storeJoinin.company_registered_capital"></mt-field>
