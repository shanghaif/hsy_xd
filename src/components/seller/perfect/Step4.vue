        ...
        <div>
            <mt-popup v-model="showDetail" position="right" class="common-popup-wrapper">
                ...
                <div class="common-popup-content">
                    <div class="label"><span>公司及联系人信息</span>
...
export default {
  ...
  methods: {
    ...
    fun_goBack(){
      ...
      if( this.pathName == 'SellerPerfect2Self' || this.pathName == 'SellerPerfect2' ){
        this.$router.go(-1);
      }else{
        this.$router.go(-2);
      }
    ...
    fun_toEdit(){
      ...
      let name = (this.storeJoinin.store_type == 0)?'SellerPerfect1':'SellerPerfect1Self';
