...
<div class="container goods-form-2">
    ...
    <div @click="$refs.unitpicker.currentValue = true">
      <mt-field label="单位" :readonly="true" v-model="goods_unit_name"></mt-field>
    </div>
...
//alert(s.indexOf("|"))
  ...
  methods: {
    ...
    nextStep () {
      ...
      if (this.goods.goods_storage_alarm && (isNaN(this.goods.goods_storage_alarm) || this.goods.goods_storage_alarm < 0)||(parseInt(this.goods.goods_storage_alarm)>parseInt(this.goods.goods_storage)) ) {
        Toast('请检查库存预警值')
        return
      }
