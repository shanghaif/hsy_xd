<template>
	<div class="more-box sty">
		...
		<div class="more-item" @click="$emit('change-popupVisible',false),$router.push({ name: 'HomeScan' })">
			<i class="iconfont">&#xe61e;</i>
			<span>扫一扫</span>
		</div>
		<div class="more-item" @click="$emit('change-popupVisible',false),$router.push({ name: 'MemberInformForm', query: { goods_id: goods_id } })" v-if="routerName === 'HomeGoodsdetail'">
			<i class="iconfont">&#xe6a3;</i>
			<span>违规举报</span>
		</div>
		...
		<div class="more-item" @click="$emit('change-popupVisible',false),$router.push({ name: 'HomeCart' })">
			<i class="iconfont">&#xe6ae;</i>
			<span>购物车</span>
		</div>
		...
		<mt-popup v-model="shareVisible" position="bottom" class="share-cont">
			<div class="share-top">
			...
			<div class="share-top"  @click="shareVisible = false">
				<p>取消</p>
			</div>
		</mt-popup>
...
.more-box {
	...
	box-shadow: 0 0 0.95rem 0 hsla(0,0%,86.3%,.85);
    ...
    height: 0;
		...
		$pc: 0.8rem;
		$pc1: 0.4rem;
		border-bottom: $pc1 solid #fff;
    border-left: $pc1 solid transparent;
	}
