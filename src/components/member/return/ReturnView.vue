<template>
	<div class="member-information">
		<!-- <div class="common-header-wrap">
			<mt-header title="退货详情" class="common-header"><mt-button slot="left" icon="back" @click="$router.go(-1)"></mt-button></mt-header>
		</div> -->
		<head-title title="退货详情"></head-title>
		...
		<mt-cell title="退货状态" v-if="refundReturn.seller_state" :value="refundReturn.seller_state"></mt-cell>
		<mt-cell title="商家备注" v-if="refundReturn.seller_message" :value="refundReturn.seller_message"></mt-cell>
