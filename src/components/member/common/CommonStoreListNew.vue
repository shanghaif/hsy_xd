          ...
          <div class="list" v-if="yesno(item.is_favorate,item.is_c)">
            ...
            <div class="flex-right">
              ...
              <div class="store-info-wrapper">
                ...
                <div @click.stop="toggleFavorite(item)" class="btn" :class="{'active':item.is_favorate}"><i class="iconfont">&#xe610;</i>团自提</div>
              </div>
...
user:state => state.member.info,
  ...
  methods: {
    ...
    onPickerConfirm (values) {
      ...
      this.$forceUpdate()
      this.setActiveSortkey(this.currentSortKey,this.currentSortKey.id);
    },
    getRegionStr (values) {
      let title = ''
...
console.log(res)
  ...
  save () {
	 savetuan(this.quyuid, this.token).then(res => {console.log(res)})
},
  test () {
