<template>
	<div class="common-send-code hsy_main send-code">
		<mt-cell title="验证方式"><mt-radio v-model="verifyType" :options="verifyTypeOptions"></mt-radio></mt-cell>
		...
		<mt-button class="hsy_f hsy_btn" @click="checkAuthCode">下一步</mt-button>
	</div>
</template>
