    ...
    <div class="common-header-wrap">
      ...
      <div>
          ...
          <!-- <div v-if="!isSame">
              ...
              <mt-field label="个人开户名" v-model="storeJoinin.settlement_bank_account_name"></mt-field>
              <mt-field label="个人银行账号" v-model="storeJoinin.settlement_bank_account_number"></mt-field>
