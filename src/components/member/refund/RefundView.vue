<template>
	<div class="member-information">
		...
		<mt-cell title="退款状态" v-if="refund.seller_state" :value="refund.seller_state"></mt-cell>
		<mt-cell title="商家备注" v-if="refund.seller_message" :value="refund.seller_message"></mt-cell>
