        ...
        <div class="sendtime">
          <a class="mint-cell">
            ...
            <div class="mint-cell-wrapper" style="display: flex;justify-content: space-between;flex-wrap: wrap;padding: 1px 14px;">
              <div @click="onDate1" class="mint-cell-value endtime">日期：{{sendTime?$moment(sendTime).format('YYYY-MM-DD'):'配送起始时间'}}</div>
              <!-- <span>时间</span> -->
              <div @click="onRegion" class="mint-cell-value endtime">时间：{{endTimeName}}</div>
            </div>
