...
<div class="more-item" @click="$router.push({name:'HomeScan'})"><i class="iconfont">&#xe61e;</i>扫一扫</div>
        ...
        <div class="more-item" @click="clearHuan"><i class="iconfont">&#xe635;</i>清除缓存</div>
        <i class="arrow"></i>
...
export default {
  ...
  computed: {
    ...mapState({
      ...
      goodsDetailInfo: state => state.goodsdetail.detailInfo,
    }),
    routerName () {
...
<style lang="scss" scoped>
    .more-box{opacity:.9;background:#000;position:absolute;width:5.6rem;z-index:2;right:0.3rem;top:2.2rem;border-radius:0.2rem;}
    ...
    .more-box .share-list .share-item.weixin:before{content:"\e647";background:#228B22;}
    ...
    .more-box .weixin-share{width:50vw;}
...
.sty{
  ...
  .share-list{
	...
	.h4{
		height:2rem;background: rgba(0,0,0,.28);
	}
