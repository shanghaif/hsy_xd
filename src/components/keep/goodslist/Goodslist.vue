 ...
 * @Autor: Yan Wenran
 * @Date: 2021-01-17 10:34:36
 * @LastEditors: Do not edit
 * @LastEditTime: 2021-01-19 17:12:19
-->
<template>
	<div class="container">
		<home-common-search2 :value="params.keyword"></home-common-search2>
		<goodslist-body :store_id_props="params.store_id"></goodslist-body>
	</div>
</template>
	...
	data() {
		return {
			params: {
				...
				store_id: this.$route.query.store_id ? this.$route.query.store_id : '',
			}
		};
	},
	created() {},
