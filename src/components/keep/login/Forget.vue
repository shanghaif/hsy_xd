...
<script>
import { forget } from '../../../apikeep/login';
import { getSmsCaptcha } from '../../../apikeep/login';
	...
	methods: {
      ...
      if (this.password !== this.confirmPassword) {
        ...
        return false
			...
			forget(this.username, this.password,this.confirmPassword,this.verifyCodeMobile).then(
				res => {
