<template>
    ...
    <!-- <tuanclass-body v-if="tuan_show" ref="tuan"></tuanclass-body> -->
		<goodsclass-body ref="mychild" :isGoodsClass="false"  @getScrollTop="getScrollTop" ></goodsclass-body>
...
export default {
  ...
  beforeRouteEnter (to, from, next) {
    ...
    next(vm => {
        ...
        // 旧版本 缓存数据 滚动条
        vm.$nextTick(()=>{
          vm.$children[2].$refs.leftCont.scrollTop = vm.leftContScrollTop;
          vm.$children[2].$refs.rightCont.scrollTop = vm.rightContScrollTop;
        })
      )
      resetRem();
		})
