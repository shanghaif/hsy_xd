								...
								<ul class="good">
									<li v-for="(item, index2) in obj.goods_list" :key="index2" @click="goDetails(item)">
										...
										<div class="right-info">
											...
											<div class="price-num">
												<div class="price">
													￥{{ parseFloat(item.goods_price*item[mclassGoodsPrice]).toFixed(2) }}
												</div>
												<!-- 点击 加减法 按钮 -->
												<div class="math">
													<div class="pb pop"
						...
						<div class="cart-info">
							...
							<div class="bottom">
								<span>
									...
									<span>{{parseFloat(v.goods_price*v[mclassGoodsPrice]).toFixed(2) }}</span>
								</span>
								<div>
      ...
      const index=this.listHeight.findIndex((item,index)=>{
		...
		totalPrice(){
			...
			for( var obj of this.cartData ){
				...
				total += obj.num * parseFloat(obj.goods_price*obj[this.mclassGoodsPrice]).toFixed(2);
			}
