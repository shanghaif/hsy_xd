		...
		<div class="goodslist-body show-goods-list">
			...
			<div class="flex-wrapper" v-infinite-scroll="getMore" infinite-scroll-disabled="loading" infinite-scroll-distance="10">
				<div class="ui-product-body" v-for="(item, index) in goodsList" v-bind:key="index">
					<div class="list-wrapper" v-on:click="goDetail(item.goods_id)">
						<div class="list">
							...
							<div class="flex-right">
								...
								<div class="p-info">
									<span class="platform_store_wrapper" v-show="item.is_platform_store"><span class="platform_store">自营</span></span>
...
export default {
	...
	methods: {
		...
		getGoodsList(ispush) {
			...
			searchGoodsList(this.params).then(res => {
