			...
			<div v-infinite-scroll="loadMore" infinite-scroll-disabled="loading" infinite-scroll-distance="10">
				...
				<div class="flex-wrapper" v-infinite-scroll="loadMore" infinite-scroll-disabled="loading" infinite-scroll-distance="10">
					<div class="ui-product-body" v-for="(item, index) in brandList" v-bind:key="index">
						...
						<div class="list-wrapper" @click="goDetail(item)">
							<div class="list">
  ...
  beforeRouteEnter (to, from, next) {
    ...
    next(vm => { 
      // if( from.name == "HomeStoreGoodslist" ){
				if (from.name != 'HomeStoreGoodslist' && from.name != 'HomeStoreFoodslist') {
					//更新初始化列表数据
					vm.keywords = '';
					vm.brandList = [];
				...
				resetRem();
				// console.log('先',to.meta.isBack);
        /*vm.keywords = vm.utils.fetch('StoreKeyword')[0];
        ...
        vm.params.lng1 = vm.lng;
				...
				getStoreList('','', vm.keywords, 0, 0, '', vm.params.page, '','').then(res => {
					vm.buildData(false, res);
				});*/
