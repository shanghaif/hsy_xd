	...
	<div class="home-base">
		...
		<div class="common-footer-wrap">
			<mt-tabbar v-model="home_selected" fixed class="common-footer">
				...
				<!-- <mt-tab-item class="item-wrap" :class="{ active: $route.name == 'HomeStoredetail' }" id="home_index">
					<router-link :to="{ name: 'HomeStoredetail', query: { id: store_id } }" class="item">
						<i class="iconfont icon-31rexiao" />
				...
				<mt-tab-item class="item-wrap" :class="{ active: $route.name == 'HomeStoreGoodslist' }" id="home_goodsclass">
					<router-link :to="{ name: 'HomeStoreGoodslist', query: { id: store_id } }" class="item">
						<!-- <i class="iconfont icon-31quanbushangpin" /> -->
						<img :src="$route.name == 'HomeStoreGoodslist' ? iconProductSelect2 : iconProductSelect1" alt="" />
						<span class="text">可选商品</span>
					</router-link>
				</mt-tab-item>
				<mt-tab-item class="item-wrap" :class="{ active: $route.name == 'HomeStoreGoodsclass' }" id="home_search">
					<router-link :to="{ name: 'HomeStoreGoodsclass', query: { id: store_id } }" class="item">
						<!-- <i class="iconfont icon-sousuo1" /> -->
						<img :src="$route.name == 'HomeStoreGoodsclass' ? iconStoreGoods2 : iconStoreGoods1" alt="" />
