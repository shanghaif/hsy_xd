...
export default {
	...
	created() {
		...
		if (this.mclass == 1) {
			priceAs = this.detailInfo.goods_l_price;
		}
		if (this.mclass == 2) {
			priceAs = this.detailInfo.goods_c_price;
		}
		if (this.mclass == 3 || this.mclass == 6) {
			priceAs = this.detailInfo.goods_p_price;
		}
		if (this.mclass == 4) {
			priceAs = this.detailInfo.goods_B_price;
		}
		if (this.mclass == 5) {
			priceAs = this.detailInfo.goods_j_price;
		}
