...
<template>
	<div>
		...
		<header-more2  :goodsDetailInfo="detailInfo" :goods_id="goods_id" @change-popupVisible="changePopupVisible" :share_info="share_config" v-show="popupVisible" :showDot="showDot"></header-more2>
	</div>
</template>
